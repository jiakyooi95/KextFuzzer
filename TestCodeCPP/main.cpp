//#include <iostream> <-- No way to instrument this code because of Apple's shitty header files linking policy
#include <IOKit/IOLib.h>
#include <IOKit/IOKitKeys.h>
#include <libkern/OSByteOrder.h>
#include "CustomUserClient.h"
...
IOExternalMethod *get(IOService** targetP, UInt32* index);
IOReturn external(uint32_t selector, IOExternalMethodArguments* args, IOExternalMethodDispatch* dispatch, OSObject* target, void* reference);

/*
 virtual kern_return_t           IOConnectCallMtehod(mach_port_t connection, uint64_t selector, const uint64_t *input, uint32_t inputCnt, const void *inputStruct, size_t inputStructCnt, uint64_t *output, uint32_t *outputCnt, void *outputStruct, size_t *outputStructCntP);
 */
...
//virtual IOExternalMethodDispatch IOEnum();
